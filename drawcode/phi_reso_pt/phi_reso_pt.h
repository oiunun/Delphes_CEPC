...
// Tue Nov  1 22:41:03 2022 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file: ../../rootfile/e2e2h_X_1_9_3.root
//////////////////////////////////////////////////////////

#ifndef phi_reso_pt_h
#define phi_reso_pt_h
...
#ifdef phi_reso_pt_cxx
phi_reso_pt::phi_reso_pt(TTree *tree) : fChain(0) 
{
...
phi_reso_pt::~phi_reso_pt()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t phi_reso_pt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t phi_reso_pt::LoadTree(Long64_t entry)
{
...
void phi_reso_pt::Init(TTree *tree)
{
...
void phi_reso_pt::Show(Long64_t entry)
{
...
Int_t phi_reso_pt::Cut(Long64_t entry)
{
