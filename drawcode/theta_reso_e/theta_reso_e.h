...
// Tue Nov  8 21:42:18 2022 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file: ../../rootfile/qqh_aa_1_9_1.root
//////////////////////////////////////////////////////////

#ifndef theta_reso_e_h
#define theta_reso_e_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTrack = 42;
   static constexpr Int_t kMaxTower = 61;
   static constexpr Int_t kMaxEFlowTrack = 41;
   static constexpr Int_t kMaxEFlowPhoton = 33;
   static constexpr Int_t kMaxEFlowNeutralHadron = 15;
   static constexpr Int_t kMaxParticleFlowCandidate = 69;
   ...
   static constexpr Int_t kMaxWoMuonPair = 69;
   ...
   theta_reso_e(TTree *tree=0);
   virtual ~theta_reso_e();
...
#ifdef theta_reso_e_cxx
theta_reso_e::theta_reso_e(TTree *tree) : fChain(0) 
{
...
theta_reso_e::~theta_reso_e()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t theta_reso_e::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t theta_reso_e::LoadTree(Long64_t entry)
{
...
void theta_reso_e::Init(TTree *tree)
{
...
void theta_reso_e::Show(Long64_t entry)
{
...
Int_t theta_reso_e::Cut(Long64_t entry)
{
