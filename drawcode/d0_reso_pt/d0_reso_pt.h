...
// Thu Oct 13 21:24:30 2022 by ROOT version 6.22/06
...
#ifdef d0_reso_pt_cxx
d0_reso_pt::d0_reso_pt(TTree *tree) : fChain(0) 
{
...
d0_reso_pt::~d0_reso_pt()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t d0_reso_pt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t d0_reso_pt::LoadTree(Long64_t entry)
{
...
void d0_reso_pt::Init(TTree *tree)
{
...
void d0_reso_pt::Show(Long64_t entry)
{
...
Int_t d0_reso_pt::Cut(Long64_t entry)
{
