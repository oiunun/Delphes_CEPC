...
// Thu Nov  3 14:29:33 2022 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file: ../../rootfile/e2e2h_X_1_9.root
//////////////////////////////////////////////////////////
...
#ifdef prob_cxx
prob::prob(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../rootfile/e2e2h_X_1_9.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../rootfile/e2e2h_X_1_9.root");
      }
...
Int_t prob::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t prob::LoadTree(Long64_t entry)
{
