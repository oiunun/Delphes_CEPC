...
// Wed Nov  9 10:18:40 2022 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file: ../../../rootfile/e2e2h_X_1_9_1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTrack = 56;
   static constexpr Int_t kMaxTower = 72;
   static constexpr Int_t kMaxEFlowTrack = 54;
   static constexpr Int_t kMaxEFlowPhoton = 37;
   static constexpr Int_t kMaxEFlowNeutralHadron = 22;
...
Int_t dndx::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dndx::LoadTree(Long64_t entry)
{
