...
// Thu Oct 13 21:24:35 2022 by ROOT version 6.22/06
...
#ifdef pt_reso_pt_cxx
pt_reso_pt::pt_reso_pt(TTree *tree) : fChain(0) 
{
...
pt_reso_pt::~pt_reso_pt()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t pt_reso_pt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pt_reso_pt::LoadTree(Long64_t entry)
{
...
void pt_reso_pt::Init(TTree *tree)
{
...
void pt_reso_pt::Show(Long64_t entry)
{
...
Int_t pt_reso_pt::Cut(Long64_t entry)
{
