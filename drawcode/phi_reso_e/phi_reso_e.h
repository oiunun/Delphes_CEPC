...
// Tue Nov  8 21:41:48 2022 by ROOT version 6.22/06
...
#ifdef phi_reso_e_cxx
phi_reso_e::phi_reso_e(TTree *tree) : fChain(0) 
{
...
phi_reso_e::~phi_reso_e()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t phi_reso_e::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t phi_reso_e::LoadTree(Long64_t entry)
{
...
void phi_reso_e::Init(TTree *tree)
{
...
void phi_reso_e::Show(Long64_t entry)
{
...
Int_t phi_reso_e::Cut(Long64_t entry)
{
