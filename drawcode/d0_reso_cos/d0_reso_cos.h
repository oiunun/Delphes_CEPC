...
// Thu Oct 13 21:23:04 2022 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file: e2e2h_X_1_9_1.root
//////////////////////////////////////////////////////////

#ifndef d0_reso_cos_h
#define d0_reso_cos_h
...
#ifdef d0_reso_cos_cxx
d0_reso_cos::d0_reso_cos(TTree *tree) : fChain(0) 
{
...
d0_reso_cos::~d0_reso_cos()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t d0_reso_cos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t d0_reso_cos::LoadTree(Long64_t entry)
{
...
void d0_reso_cos::Init(TTree *tree)
{
...
void d0_reso_cos::Show(Long64_t entry)
{
...
Int_t d0_reso_cos::Cut(Long64_t entry)
{
