#ifndef LGClusterSmearer_h
#define LGClusterSmearer_h 1
...
namespace marlin{
	 ...
	 *
	 *  @author F. Gaede, DESY
	 *  @version $Id: LGClusterSmearer.h,v 1.2 2005-10-11 12:56:28 gaede Exp $ 
	 */
	...
	class LGClusterSmearer : public IFourVectorSmearer {
		...
		LGClusterSmearer(const std::vector<float>& resVec ) ;


		/** Virtual d'tor.*/
		virtual ~LGClusterSmearer() {} 
