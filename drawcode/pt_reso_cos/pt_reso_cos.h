...
// Thu Oct 13 21:24:39 2022 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file: e2e2h_X_1_9_1.root
//////////////////////////////////////////////////////////

#ifndef pt_reso_cos_h
#define pt_reso_cos_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 283;
   static constexpr Int_t kMaxGenVertex = 19;
   static constexpr Int_t kMaxTrack = 52;
   static constexpr Int_t kMaxTower = 73;
   static constexpr Int_t kMaxEFlowTrack = 50;
   static constexpr Int_t kMaxEFlowPhoton = 37;
   static constexpr Int_t kMaxEFlowNeutralHadron = 18;
   static constexpr Int_t kMaxParticleFlowCandidate = 84;
   static constexpr Int_t kMaxCaloPhoton = 37;
   static constexpr Int_t kMaxPhotonEff = 16;
   static constexpr Int_t kMaxPhotonIso = 16;
   static constexpr Int_t kMaxGenJet = 2;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxJet = 2;
   static constexpr Int_t kMaxFastJet = 2;
   static constexpr Int_t kMaxElectron = 4;
   static constexpr Int_t kMaxPhoton = 16;
   static constexpr Int_t kMaxMuon = 2;
   static constexpr Int_t kMaxWoMuonPair = 82;
   ...
   Int_t           Jet_size;
   Int_t           FastJet_;
   UInt_t          FastJet_fUniqueID[kMaxFastJet];   //[FastJet_]
   UInt_t          FastJet_fBits[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_PT[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_Eta[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_Phi[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_T[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_Mass[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_DeltaEta[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_DeltaPhi[kMaxFastJet];   //[FastJet_]
   UInt_t          FastJet_Flavor[kMaxFastJet];   //[FastJet_]
   UInt_t          FastJet_FlavorAlgo[kMaxFastJet];   //[FastJet_]
   UInt_t          FastJet_FlavorPhys[kMaxFastJet];   //[FastJet_]
   UInt_t          FastJet_BTag[kMaxFastJet];   //[FastJet_]
   UInt_t          FastJet_BTagAlgo[kMaxFastJet];   //[FastJet_]
   UInt_t          FastJet_BTagPhys[kMaxFastJet];   //[FastJet_]
   UInt_t          FastJet_TauTag[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_TauWeight[kMaxFastJet];   //[FastJet_]
   Int_t           FastJet_Charge[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_EhadOverEem[kMaxFastJet];   //[FastJet_]
   Int_t           FastJet_NCharged[kMaxFastJet];   //[FastJet_]
   Int_t           FastJet_NNeutrals[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_NeutralEnergyFraction[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_ChargedEnergyFraction[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_Beta[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_BetaStar[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_MeanSqDeltaR[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_PTD[kMaxFastJet];   //[FastJet_]
   Float_t         FastJet_FracPt[kMaxFastJet][5];   //[FastJet_]
   Float_t         FastJet_Tau[kMaxFastJet][5];   //[FastJet_]
   TLorentzVector  FastJet_SoftDroppedJet[kMaxFastJet];
   TLorentzVector  FastJet_SoftDroppedSubJet1[kMaxFastJet];
   TLorentzVector  FastJet_SoftDroppedSubJet2[kMaxFastJet];
   TLorentzVector  FastJet_TrimmedP4[5][kMaxFastJet];
   TLorentzVector  FastJet_PrunedP4[5][kMaxFastJet];
   TLorentzVector  FastJet_SoftDroppedP4[5][kMaxFastJet];
   Int_t           FastJet_NSubJetsTrimmed[kMaxFastJet];   //[FastJet_]
   Int_t           FastJet_NSubJetsPruned[kMaxFastJet];   //[FastJet_]
   Int_t           FastJet_NSubJetsSoftDropped[kMaxFastJet];   //[FastJet_]
   Double_t        FastJet_ExclYmerge23[kMaxFastJet];   //[FastJet_]
   Double_t        FastJet_ExclYmerge34[kMaxFastJet];   //[FastJet_]
   Double_t        FastJet_ExclYmerge45[kMaxFastJet];   //[FastJet_]
   Double_t        FastJet_ExclYmerge56[kMaxFastJet];   //[FastJet_]
   TRefArray       FastJet_Constituents[kMaxFastJet];
   TRefArray       FastJet_Particles[kMaxFastJet];
   TLorentzVector  FastJet_Area[kMaxFastJet];
   Int_t           FastJet_size;
   Int_t           Electron_;
   ...
   TBranch        *b_Jet_size;   //!
   TBranch        *b_FastJet_;   //!
   TBranch        *b_FastJet_fUniqueID;   //!
   TBranch        *b_FastJet_fBits;   //!
   TBranch        *b_FastJet_PT;   //!
   TBranch        *b_FastJet_Eta;   //!
   TBranch        *b_FastJet_Phi;   //!
   TBranch        *b_FastJet_T;   //!
   TBranch        *b_FastJet_Mass;   //!
   TBranch        *b_FastJet_DeltaEta;   //!
   TBranch        *b_FastJet_DeltaPhi;   //!
   TBranch        *b_FastJet_Flavor;   //!
   TBranch        *b_FastJet_FlavorAlgo;   //!
   TBranch        *b_FastJet_FlavorPhys;   //!
   TBranch        *b_FastJet_BTag;   //!
   TBranch        *b_FastJet_BTagAlgo;   //!
   TBranch        *b_FastJet_BTagPhys;   //!
   TBranch        *b_FastJet_TauTag;   //!
   TBranch        *b_FastJet_TauWeight;   //!
   TBranch        *b_FastJet_Charge;   //!
   TBranch        *b_FastJet_EhadOverEem;   //!
   TBranch        *b_FastJet_NCharged;   //!
   TBranch        *b_FastJet_NNeutrals;   //!
   TBranch        *b_FastJet_NeutralEnergyFraction;   //!
   TBranch        *b_FastJet_ChargedEnergyFraction;   //!
   TBranch        *b_FastJet_Beta;   //!
   TBranch        *b_FastJet_BetaStar;   //!
   TBranch        *b_FastJet_MeanSqDeltaR;   //!
   TBranch        *b_FastJet_PTD;   //!
   TBranch        *b_FastJet_FracPt;   //!
   TBranch        *b_FastJet_Tau;   //!
   TBranch        *b_FastJet_SoftDroppedJet;   //!
   TBranch        *b_FastJet_SoftDroppedSubJet1;   //!
   TBranch        *b_FastJet_SoftDroppedSubJet2;   //!
   TBranch        *b_FastJet_TrimmedP4;   //!
   TBranch        *b_FastJet_PrunedP4;   //!
   TBranch        *b_FastJet_SoftDroppedP4;   //!
   TBranch        *b_FastJet_NSubJetsTrimmed;   //!
   TBranch        *b_FastJet_NSubJetsPruned;   //!
   TBranch        *b_FastJet_NSubJetsSoftDropped;   //!
   TBranch        *b_FastJet_ExclYmerge23;   //!
   TBranch        *b_FastJet_ExclYmerge34;   //!
   TBranch        *b_FastJet_ExclYmerge45;   //!
   TBranch        *b_FastJet_ExclYmerge56;   //!
   TBranch        *b_FastJet_Constituents;   //!
   TBranch        *b_FastJet_Particles;   //!
   TBranch        *b_FastJet_Area;   //!
   TBranch        *b_FastJet_size;   //!
   TBranch        *b_Electron_;   //!
...
#ifdef pt_reso_cos_cxx
pt_reso_cos::pt_reso_cos(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../rootfile/e2e2h_X_1_9_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../rootfile/e2e2h_X_1_9_1.root");
      }
...
pt_reso_cos::~pt_reso_cos()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t pt_reso_cos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pt_reso_cos::LoadTree(Long64_t entry)
{
...
void pt_reso_cos::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("FastJet", &FastJet_, &b_FastJet_);
   fChain->SetBranchAddress("FastJet.fUniqueID", FastJet_fUniqueID, &b_FastJet_fUniqueID);
   fChain->SetBranchAddress("FastJet.fBits", FastJet_fBits, &b_FastJet_fBits);
   fChain->SetBranchAddress("FastJet.PT", FastJet_PT, &b_FastJet_PT);
   fChain->SetBranchAddress("FastJet.Eta", FastJet_Eta, &b_FastJet_Eta);
   fChain->SetBranchAddress("FastJet.Phi", FastJet_Phi, &b_FastJet_Phi);
   fChain->SetBranchAddress("FastJet.T", FastJet_T, &b_FastJet_T);
   fChain->SetBranchAddress("FastJet.Mass", FastJet_Mass, &b_FastJet_Mass);
   fChain->SetBranchAddress("FastJet.DeltaEta", FastJet_DeltaEta, &b_FastJet_DeltaEta);
   fChain->SetBranchAddress("FastJet.DeltaPhi", FastJet_DeltaPhi, &b_FastJet_DeltaPhi);
   fChain->SetBranchAddress("FastJet.Flavor", FastJet_Flavor, &b_FastJet_Flavor);
   fChain->SetBranchAddress("FastJet.FlavorAlgo", FastJet_FlavorAlgo, &b_FastJet_FlavorAlgo);
   fChain->SetBranchAddress("FastJet.FlavorPhys", FastJet_FlavorPhys, &b_FastJet_FlavorPhys);
   fChain->SetBranchAddress("FastJet.BTag", FastJet_BTag, &b_FastJet_BTag);
   fChain->SetBranchAddress("FastJet.BTagAlgo", FastJet_BTagAlgo, &b_FastJet_BTagAlgo);
   fChain->SetBranchAddress("FastJet.BTagPhys", FastJet_BTagPhys, &b_FastJet_BTagPhys);
   fChain->SetBranchAddress("FastJet.TauTag", FastJet_TauTag, &b_FastJet_TauTag);
   fChain->SetBranchAddress("FastJet.TauWeight", FastJet_TauWeight, &b_FastJet_TauWeight);
   fChain->SetBranchAddress("FastJet.Charge", FastJet_Charge, &b_FastJet_Charge);
   fChain->SetBranchAddress("FastJet.EhadOverEem", FastJet_EhadOverEem, &b_FastJet_EhadOverEem);
   fChain->SetBranchAddress("FastJet.NCharged", FastJet_NCharged, &b_FastJet_NCharged);
   fChain->SetBranchAddress("FastJet.NNeutrals", FastJet_NNeutrals, &b_FastJet_NNeutrals);
   fChain->SetBranchAddress("FastJet.NeutralEnergyFraction", FastJet_NeutralEnergyFraction, &b_FastJet_NeutralEnergyFraction);
   fChain->SetBranchAddress("FastJet.ChargedEnergyFraction", FastJet_ChargedEnergyFraction, &b_FastJet_ChargedEnergyFraction);
   fChain->SetBranchAddress("FastJet.Beta", FastJet_Beta, &b_FastJet_Beta);
   fChain->SetBranchAddress("FastJet.BetaStar", FastJet_BetaStar, &b_FastJet_BetaStar);
   fChain->SetBranchAddress("FastJet.MeanSqDeltaR", FastJet_MeanSqDeltaR, &b_FastJet_MeanSqDeltaR);
   fChain->SetBranchAddress("FastJet.PTD", FastJet_PTD, &b_FastJet_PTD);
   fChain->SetBranchAddress("FastJet.FracPt[5]", FastJet_FracPt, &b_FastJet_FracPt);
   fChain->SetBranchAddress("FastJet.Tau[5]", FastJet_Tau, &b_FastJet_Tau);
   fChain->SetBranchAddress("FastJet.SoftDroppedJet", FastJet_SoftDroppedJet, &b_FastJet_SoftDroppedJet);
   fChain->SetBranchAddress("FastJet.SoftDroppedSubJet1", FastJet_SoftDroppedSubJet1, &b_FastJet_SoftDroppedSubJet1);
   fChain->SetBranchAddress("FastJet.SoftDroppedSubJet2", FastJet_SoftDroppedSubJet2, &b_FastJet_SoftDroppedSubJet2);
   fChain->SetBranchAddress("FastJet.TrimmedP4[5]", FastJet_TrimmedP4, &b_FastJet_TrimmedP4);
   fChain->SetBranchAddress("FastJet.PrunedP4[5]", FastJet_PrunedP4, &b_FastJet_PrunedP4);
   fChain->SetBranchAddress("FastJet.SoftDroppedP4[5]", FastJet_SoftDroppedP4, &b_FastJet_SoftDroppedP4);
   fChain->SetBranchAddress("FastJet.NSubJetsTrimmed", FastJet_NSubJetsTrimmed, &b_FastJet_NSubJetsTrimmed);
   fChain->SetBranchAddress("FastJet.NSubJetsPruned", FastJet_NSubJetsPruned, &b_FastJet_NSubJetsPruned);
   fChain->SetBranchAddress("FastJet.NSubJetsSoftDropped", FastJet_NSubJetsSoftDropped, &b_FastJet_NSubJetsSoftDropped);
   fChain->SetBranchAddress("FastJet.ExclYmerge23", FastJet_ExclYmerge23, &b_FastJet_ExclYmerge23);
   fChain->SetBranchAddress("FastJet.ExclYmerge34", FastJet_ExclYmerge34, &b_FastJet_ExclYmerge34);
   fChain->SetBranchAddress("FastJet.ExclYmerge45", FastJet_ExclYmerge45, &b_FastJet_ExclYmerge45);
   fChain->SetBranchAddress("FastJet.ExclYmerge56", FastJet_ExclYmerge56, &b_FastJet_ExclYmerge56);
   fChain->SetBranchAddress("FastJet.Constituents", FastJet_Constituents, &b_FastJet_Constituents);
   fChain->SetBranchAddress("FastJet.Particles", FastJet_Particles, &b_FastJet_Particles);
   fChain->SetBranchAddress("FastJet.Area", FastJet_Area, &b_FastJet_Area);
   fChain->SetBranchAddress("FastJet_size", &FastJet_size, &b_FastJet_size);
...
void pt_reso_cos::Show(Long64_t entry)
{
...
Int_t pt_reso_cos::Cut(Long64_t entry)
{
