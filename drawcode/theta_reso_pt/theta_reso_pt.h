...
// Tue Nov  1 22:31:02 2022 by ROOT version 6.22/06
// from TTree Delphes/Analysis tree
// found on file: ../../rootfile/e2e2h_X_1_9_3.root
//////////////////////////////////////////////////////////

#ifndef theta_reso_pt_h
#define theta_reso_pt_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxTower = 72;
   static constexpr Int_t kMaxEFlowTrack = 51;
   static constexpr Int_t kMaxEFlowPhoton = 36;
   static constexpr Int_t kMaxEFlowNeutralHadron = 20;
   static constexpr Int_t kMaxParticleFlowCandidate = 85;
   static constexpr Int_t kMaxCaloPhoton = 36;
   ...
   static constexpr Int_t kMaxWoMuonPair = 83;
   ...
   theta_reso_pt(TTree *tree=0);
   virtual ~theta_reso_pt();
...
#ifdef theta_reso_pt_cxx
theta_reso_pt::theta_reso_pt(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../rootfile/e2e2h_X_1_9_3.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../rootfile/e2e2h_X_1_9_3.root");
      }
...
theta_reso_pt::~theta_reso_pt()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t theta_reso_pt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t theta_reso_pt::LoadTree(Long64_t entry)
{
...
void theta_reso_pt::Init(TTree *tree)
{
...
void theta_reso_pt::Show(Long64_t entry)
{
...
Int_t theta_reso_pt::Cut(Long64_t entry)
{
